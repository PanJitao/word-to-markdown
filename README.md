...
1. 直接从本仓库的 [`release/ExchangeMD.exe`](release/ExchangeMD.exe) 下载成品（单文件，约 3 MB，免安装）。
   - 也可点 GitHub 页面右上角 **Releases** 获取各版本。
2. 双击即可运行，**无需安装、完全离线**，可放任意目录、U 盘随身携带。
3. 首次使用建议点右上角 **⚙️ 设置**：
